...
public class Mitest {
    ...
    private static void crearCoches() {
        ...
        for (int i = 0; i < numCoches; i++) {
            ...
            //coches[i]=new MiCoche(marca,modelo,cambio,capota);
        }
    }
                    ...
                    try {
                        switch (userOpcion){
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                if (coches[user].comprovaMotor().equals(EstatsMotorCotxe.EnMarxa)){
                                    ...
                                    System.out.println("---------------------------");
                                    System.out.println("Primero hay que arrancar el coche");
                                    System.out.println("---------------------------");
                                }
                                break;
                            case 6:
